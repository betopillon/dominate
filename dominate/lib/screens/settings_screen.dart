...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _showUpgradeDialog() {
    ...
    showDialog(
      context: context,
      builder: (context) => _UpgradeAccountDialog(
        currentProfile: _currentProfile!,
  ...
  Widget _buildProfileAvatar() {
    return Container(
      ...
      child: CircleAvatar(
        ...
        child: _currentProfile?.avatarType == AvatarType.avatar && _currentProfile?.avatarOption != null
            ? Text(
      ...
      children: [
        ...
        if (_currentProfile!.isRegistered) ...[
          ...
          Row(
            ...
            children: [
              Icon(
                _currentProfile!.isEmailVerified ? Icons.verified : Icons.email,
                size: 16,
                color: _currentProfile!.isEmailVerified ? Colors.green : Colors.orange,
              ),
  ...
  Widget _buildSettingsOptions() {
    return Column(
      children: [
        ...
        if (_currentProfile == null || !_currentProfile!.isRegistered) ...[
          _buildSettingsTile(
            icon: Icons.login,
            title: 'Login',
        ...
        _buildSettingsTile(
          ...
          onTap: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Dominate v1.0.0 - Space Strategy Game'),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${(AudioService.instance.musicVolume * 100).round()}%',
                            style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                              color: const Color(0xFF00D4FF),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.person_add, color: Color(0xFF00D4FF), size: 28),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Text(
                      'Create Account',
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: AvatarOption.values.take(6).map((avatar) {
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(8),
                          border: Border.all(
                            color: isSelected ? Color(0xFF00D4FF) : Colors.white.withValues(alpha: 0.2),
                            width: isSelected ? 2 : 1,
                          ),
                        ),
                        child: Center(
                          child: Text(avatar.emoji, style: TextStyle(fontSize: 24)),
                        ),
                      ),
                    );
                  }).toList(),
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(8),
            border: Border.all(color: error != null ? Colors.red : Colors.white.withValues(alpha: 0.2)),
          ),
          child: TextField(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.login, color: Color(0xFF00D4FF), size: 28),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Text(
                      'Welcome Back',
    ...
    try {
      ...
      if (profile != null) {
        ...
        if (mounted) {
          Navigator.pop(context);
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Welcome back, ${profile.nickname}!'), backgroundColor: Colors.green),
          );
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.upgrade, color: Color(0xFF00D4FF), size: 28),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Text(
                      'Upgrade Account',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(widget.currentProfile.nickname, style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold)),
                          Text('Temporary Account', style: TextStyle(color: Colors.orange, fontSize: 10, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                  ],
              ...
              if (_generalError != null) ...[
                Container(
                  ...
                  child: Text(_generalError!, style: TextStyle(color: Colors.red, fontSize: 11)),
                ),
                const SizedBox(height: 12),
              ],
              ...
              const SizedBox(height: 4),
              Text('🏆 Global rankings  💾 Save progress  📱 Sync devices',
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading
                          ? SizedBox(height: 18, width: 18, child: CircularProgressIndicator(color: Colors.black, strokeWidth: 2))
    ...
    try {
      ...
      if (upgradedProfile != null) {
        ...
        if (mounted) {
          Navigator.pop(context);
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Account upgraded successfully!'), backgroundColor: Colors.green),
          );
      ...
      title: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.edit, color: Color(0xFF00D4FF), size: 20),
          ),
          const SizedBox(width: 12),
          const Text(
            'Edit Profile',
